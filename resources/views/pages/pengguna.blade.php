              ...
              <table class="min-w-full divide-y text-center divide-gray-200">
                <thead>
                  <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">User</th>
                    <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Role</th>
                  </tr>
                </thead>
                <tbody>
                  @foreach($users as $user)
                  <tr class="transition cursor-pointer odd:bg-white even:bg-gray-100 hover:bg-gray-100 edit-user" data-hs-overlay="#edit-modal" data-username="{{ $user->username }}" data-id="{{$user->id}}" data-role="{{ $user->role }}">
      ...
      <div id="input-modal" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none">
        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-96 m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
          <div class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
            ...
            <form action="/pengguna/store" method="post" id="user">
              {{ csrf_field() }}
                <div class="p-4 overflow-y-auto bg-gray-200">
                    <input class="transition mx-auto mt-3 py-2 px-3 ps-9 block w-80 border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none hover:bg-gray-100" type="text" name="uname" id="" placeholder="Username" required>
                    <input class="transition mx-auto mt-3 py-2 px-3 ps-9 block w-80 border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none hover:bg-gray-100" type="text" name="pass" id="" placeholder="Password" required>
                    <select class="transition mx-auto mt-3 py-2 px-3 ps-9 block w-80 border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none hover:bg-gray-100" name="role" form="user" required>
      ...
      <div id="edit-modal" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none">
        <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-96 m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
          <div class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
            ...
            <form action="/pengguna/update" method="post" id="edit">
              {{ csrf_field() }}
                <div class="p-4 overflow-y-auto bg-gray-200">
                  <input type="hidden" name="id" value="">
                  <input class="transition mx-auto mt-3 py-2 px-3 ps-9 block w-80 border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none hover:bg-gray-100" type="text" name="uname" id="" placeholder="Username" required>
                  <input class="transition mx-auto mt-3 py-2 px-3 ps-9 block w-80 border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none hover:bg-gray-100" type="text" name="pass" id="" placeholder="Password" required>
                  <select class="transition mx-auto mt-3 py-2 px-3 ps-9 block w-80 border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none hover:bg-gray-100" name="role" form="edit" required>
                    <option value="admin">Admin</option>
                    <option value="karyawan">Karyawan</option>
                  </select>
                </div>
...
<script>
  $(document).ready(function() {
      $('.edit-user').click(function() {
          ...
          $('#edit-modal input[name="uname"]').val(username);
          $('#edit-modal input[name="role"]').val(role);
          $('#delete').attr('href','/pengguna/delete/'+id);
